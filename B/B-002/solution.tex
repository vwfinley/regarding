...
For a right triangle, side $c$ (the ENTIRE hypotenuse!) is related to $a$ and $b$ by the Pythagorean theorem.
...
Symmetry of the initial setup can be used to create a symmetrical v-grove in the work by passing the rotating cutter tool along the y-axis.

...
\fancypagestyle{plain}{
  \fancyhf{} 
  \fancyhead[R]{}
  \fancyfoot[C]{\thepage\ of \pageref{LastPage}\\{\scriptsize https://github.com/vwfinley/regarding/blob/main/B/B-002/B-002.pdf}}
...
\title{B-002\\Regarding Procedure\\to Mill a V-Groove}
...
\date{July 2025\\Rev B} % Activate to display a given date or no date (if empty),

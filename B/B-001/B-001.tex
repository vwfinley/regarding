...
% To enable labels left side of figures
%%\usepackage{floatrow}
...
\title{B-001\\Regarding NMRA\textsuperscript{\textregistered} RP-25}
\author{Vincent W. Finley\thanks{\copyright 2024: Bear, DE, USA: CC BY 4.0 license\\https://creativecommons.org/licenses/by/4.0/legalcode}}
\date{November 2024} % Activate to display a given date or no date (if empty),

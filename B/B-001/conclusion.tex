...
Also, if you need point locations for an intermediate value of slope angle, say for $\theta_s = 1.5\degree$, you should perform calculations equations \ref{eqn:x_s} through \ref{eqn:d_prime}.

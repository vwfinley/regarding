...
Also, if you need point locations for an in-between value of slope angle, say for $\theta_s = 1.5$, you should perform calculations equations \ref{eqn:x_s} through \ref{eqn:d_prime}.

...
Location of circle centers and critical points is omitted.
Description of how the contour was constructed is absent.
Furthermore, missing how values $R1$, $R2$ and $R3$ were determined.
This leads to ambiguity when interpreting the drawing.

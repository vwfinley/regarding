...
Ultimately we desire to reference all the points to a common origin.
...
Length $d'$ is the actual flange depth.
It is just the vertical distance from point $p_s$, where the wheel tread begins, down to the flange bottom at $p_d$.

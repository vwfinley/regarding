...
\subsection{Right triangle with $p_s$ and $p_1$}

Figure \ref{fig:fig_f11a} shows a right triangle containing vertices at points $p_s$ and $p_1$.
Point $p_s$ is the location where the wheel tread begins, and $p_1$ is the center of the fillet arc $R1$.
The hypotenuse has length $R1$.
Let's label the lengths of the horizontal and vertical sides, $x_s$ and $y_s$ respectively.
Since the hypotenuse is at right angles to the tread slope, the angle between vertical side $y_s$ and hypotenuse $R1$ is the slope angle $\theta_s$.

The lengths of $x_s$ and $y_s$ can be found as follows.
...
\subsection{Right triangle with $p_1$ and $p_g$}
...
\subsection{Right triangle with $p_g$ and $p_2$}
...
\subsection{Right triangle with $p_2$ and $p_d$}

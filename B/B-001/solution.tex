...
\subsection{Step 1: Drawing Point $p_s$}
...
\subsection{Step 4: Drawing axes}
...
Draw a line through points $p_1$ and $p_g$, then extend it slightly beyond.
Label the line $L$.

Now sweep an arc, of radius $R2$, centered at $p_g$.
Mark the location where the arc crosses line $L$, and label it point $p_2$.

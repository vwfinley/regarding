...
\fancypagestyle{plain}{
  \fancyhf{} 
  \fancyhead[R]{}
  \fancyfoot[C]{\thepage\ of \pageref{LastPage}\\{\scriptsize https://github.com/vwfinley/regarding/blob/main/A/A-002/A-002.pdf}}
...
\date{February 2022} % Activate to display a given date or no date (if empty),

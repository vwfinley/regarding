...
\fancypagestyle{plain}{
  \fancyhf{} 
  \fancyhead[R]{}
  \fancyfoot[C]{\thepage\ of \pageref{LastPage}\\{\scriptsize https://github.com/vwfinley/regarding/blob/main/A/A-004/A-004.pdf}}
...
\title{A-004\\Regarding Classification\\of Coplanar Circle Tangents}
...
\date{April 2022} % Activate to display a given date or no date (if empty),

...
\item
From the solution section of article\footnotemark[\getrefnumber{noteA003}], use the inequality for case 9:
\begin{equation*}
	x_A > r_B + r_A
\end{equation*}
...
\item
Finally, all tangent points can be found by referring to Equations 7 and 8 from article\footnotemark[\getrefnumber{noteA002}].  This is left as an exercise for the reader.
\end{enumerate}

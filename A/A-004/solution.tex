...
Cases 0, 1, 2 and 3; from article\footnotemark[\getrefnumber{noteA003}] are examples of this class.
...
These two positions correspond to cases 4 and 8 of article\footnotemark[\getrefnumber{noteA003}]. 
...
Cases 4 and 8; from article\footnotemark[\getrefnumber{noteA003}] are examples of this class.
...
By recognizing the fact that two tangent lines together with a circle form a fillet, the angle of intersection $\theta$ can then be found by rearranging Equation 4 from article\footnotemark[\getrefnumber{noteA002}], and substituting variables for triangle $\triangle IC_{B}R_{B}$ as follows:  
\begin{equation*}
...
article\footnotemark[\getrefnumber{noteA002}].

Cases 5, 6, 7, 8 and 9; from article\footnotemark[\getrefnumber{noteA003}] are examples of this class.
...
article\footnotemark[\getrefnumber{noteA002}] can be used to find the tangent points.

Case 9 from article\footnotemark[\getrefnumber{noteA003}] is an example of this class.

%%%
\paragraph{Classification\\}
Now that four tangent classes have been defined, classifying the ten coplanar circle-pairs (identified by 
article\footnotemark[\getrefnumber{noteA003}])

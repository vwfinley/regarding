% Template based upon https://github.com/wbzyl/texworks-templates/blob/master/templates/Basic%20LaTeX%20documents/article.tex
...
\fancypagestyle{plain}{
  \fancyhf{} 
  \fancyhead[R]{}
  \fancyfoot[C]{\thepage\ of \pageref{LastPage}\\{\scriptsize https://github.com/vwfinley/regarding/blob/main/A/A-005/A-005.pdf}}
...
\title{A-005\\Regarding Relationship and Classification\\of Equal Coplanar Circles}
...
\date{May 2022} % Activate to display a given date or no date (if empty),

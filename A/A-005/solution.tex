%% List of Steps
\section{Solution}
The strategy here is to adapt the circle-pair cases from prior article\footnotemark[\getrefnumber{noteA003}] for the condition of equal circles.  Next, the effect of equal circles upon tangent classes is examined.
...
For each of the cases defined in prior work\footnotemark[\getrefnumber{noteA003}] set the radius of circle $B$ to be equal to the radius of circle $A$, such that
...
Taking case 3 inequality from prior article\footnotemark[\getrefnumber{noteA003}], substituting $r_A$ in place of $r_B$, and reducing yields:
\begin{align*}
r_A &< x_A < r_B - r_A\\
r_A &< x_A < r_A - r_A\\
r_A &< x_A < 0
...
Taking case 4 equation from prior article\footnotemark[\getrefnumber{noteA003}], substituting $r_A$ in place of $r_B$, and reducing yields:
\begin{align*}
 x_A &= r_B - r_A\\
 x_A &= r_A - r_A\\
 x_A &= 0
...
Taking case 5 inequality from prior article\footnotemark[\getrefnumber{noteA003}], substituting $r_A$ in place of $r_B$, and reducing yields:
\begin{align*}
r_B - r_A &< x_A < r_B\\
r_A - r_A &< x_A < r_A\\
0 &< x_A < r_A
...
Taking case 6 equation from prior article\footnotemark[\getrefnumber{noteA003}], substituting $r_A$ in place of $r_B$, and reducing yields:
\begin{align*}
x_A &= r_B\\
x_A &= r_A
\end{align*}
...
Taking case 7 inequality from prior article\footnotemark[\getrefnumber{noteA003}], substituting $r_A$ in place of $r_B$, and reducing yields:
\begin{align*}
r_B &< x_A < r_B + r_A\\
r_A &< x_A < r_A + r_A\\
r_A &< x_A <2 \cdot r_A
...
Taking case 8 equation from prior article\footnotemark[\getrefnumber{noteA003}], substituting $r_A$ in place of $r_B$, and reducing yields:
\begin{align*}
x_A &= r_B + r_A\\
x_A &= r_A + r_A\\
x_A &= 2 \cdot r_A
...
Taking case 9 inequality from prior article\footnotemark[\getrefnumber{noteA003}], substituting $r_A$ in place of $r_B$, and reducing yields:
\begin{align*}
x_A &> r_B + r_A\\
x_A &> r_A + r_A\\
x_A &> 2  \cdot r_A
...
For each tangent class defined in prior work\footnotemark[\getrefnumber{noteA004}] consider how tangents are affected by setting the radii of circles $A$ and $B$ to be equal.
...
The Null class covers those cases where circles $A$ and $B$ have no common tangent line, as seen in cases 0-3 in prior article\footnotemark[\getrefnumber{noteA003}].
...
Furthermore when $r_A = r_B$, cases 0 and 4 degenerate from case 4 in prior article\footnotemark[\getrefnumber{noteA003}].  The point of contact for case 4 in prior article\footnotemark[\getrefnumber{noteA003}] is $x = r_B$.  For equal circles, the point of contact
...
This can be confirmed by attempting to calculate the Outer tangent intersection point $I$ from equations 3 and 4 in prior work\footnotemark[\getrefnumber{noteA004}].
...
x_I &= \infty
\end{align*}
Substituting $x_I$ into equation 4 from prior work\footnotemark[\getrefnumber{noteA004}] yields:
\begin{equation*}
I = (x_I, 0)
\end{equation*}
\begin{equation}
...
and 9 from prior article\footnotemark[\getrefnumber{noteA003}].
...
Substituting equation \ref{eq:eqxI} here into equation 4 from prior work\footnotemark[\getrefnumber{noteA004}] yields:
...
The angle $\theta$ between the inner tangents can be found by taking equation 5 from prior work\footnotemark[\getrefnumber{noteA004}], and substituting $r_A$ in place of $r_B$:
\begin{align}

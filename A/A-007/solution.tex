...
It is worth noting for all cases resulting in regions of intersection, only a pair of Class C outer tangent lines are possible.
...
Now, combining the three conditions yields a general condition, which circle pairs must satisfy in order to have a region of intersection:
\begin{equation}
\boxed{
0 < x_A  < 2 \cdot r_A
}
...
distance between the centers of circles $C_B$ and $C_A$ as
...
locations $P'$ and $P''$ are given as $P'=(-a,0)$ and $P''=(a,0)$ respectively.
...
This is due to the fact that the revolved circle intersectional is just a solid tangent ogive and its reflection about the x-axis.
\begin{equation}
\boxed{

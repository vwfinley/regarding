...
\label{fig:fig_a}
\end{figure}
Here the ogive is drawn directly in a single step, whereas, the previous article presents the process in extensive detail.
Each article has something useful to teach, as each approaches tangent ogive construction from a different perspective.
The prior article emphasizes ogive geometry.
...
by describing how tangent ogives and intersections of equal circles are related.

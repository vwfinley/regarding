...
\fancypagestyle{plain}{
  \fancyhf{} 
  \fancyhead[R]{}
  \fancyfoot[C]{\thepage\ of \pageref{LastPage}\\{\scriptsize https://github.com/vwfinley/regarding/blob/main/A/A-007/A-007.pdf}}
...
\title{A-007\\Regarding Circle Intersections\\and Tangent Ogives}
...
\date{October 2022} % Activate to display a given date or no date (if empty),

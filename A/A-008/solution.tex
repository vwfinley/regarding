...
\begin{equation}
x_A = \overline{BD} = r \cdot \cos{\alpha} \label{eq:eq_xa} 
\end{equation}

Since $r$ was found in equation \ref{eq:eq_r}, use equations \ref{eq:eqi} and \label{eq:eq_xa} to find $A$.
\begin{align}
A &= (x_A, y_A)\\
A &= (\overline{BD}, -i)\\
A &= (r \cdot \cos{\alpha}, h - r)
\end{align}

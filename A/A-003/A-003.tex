...
\fancypagestyle{plain}{
  \fancyhf{} 
  \fancyhead[R]{}
  \fancyfoot[C]{\thepage\ of \pageref{LastPage}\\{\scriptsize https://github.com/vwfinley/regarding/blob/main/A/A-003/A-003.pdf}}
...
\title{A-003\\Regarding Coplanar Circles}
...
\date{March 2022} % Activate to display a given date or no date (if empty),

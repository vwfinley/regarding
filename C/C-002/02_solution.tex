...
Since MS Windows already has a desktop, there is no need to install an Ubuntu desktop distro.
We can use the MS Windows desktop as terminal that can connect to remote systems.

\subsection{Strategy}
So, what's our strategy to setup a remote development enviroment?

...
\fancypagestyle{plain}{
  \fancyhf{} 
  \fancyhead[R]{}
  \fancyfoot[C]{\thepage\ of \pageref{LastPage}\\{\scriptsize https://github.com/vwfinley/regarding/blob/main/C/C-002/C-002.pdf}}
...
\title{C-002\\Regarding Configuration of\\Ubuntu Server for Development}
...
\date{July 2025\\Rev A} % Activate to display a given date or no date (if empty),
...
\input{03_server.tex}
\input{04_install.tex}
\input{05_network.tex}
\input{06_cloud.tex}
\input{07_ssh.tex}
\input{08_other.tex}

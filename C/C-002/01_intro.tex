...
The previous article\footnote{https://github.com/vwfinley/regarding/blob/main/C/C-001/C-001.pdf} described how to setup an Ubuntu desktop distribution as a VM and access it from VSCode.
...
Why?
Because desktop distributions provide a GUI that need either local console access or a remote desktop client.
...
Less packages equals smaller footprint.

...
Instructions to install Docker given by https://docs.docker.com/engine/install/ubuntu/#install-using-the-repository are repeated here in case that webpage disappears.

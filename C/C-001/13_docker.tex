...
Instructions to install Docker given by \begin{verbatim}https://docs.docker.com/engine/install/ubuntu/#install-using-the-repository\end{verbatim} are repeated here in case that webpage disappears.

...
\begin{enumerate}
  ...
  \item Click inside the boot window that appears, select ``Try or Install Ubuntu'', and hit enter.
\end{enumerate}
...
\begin{enumerate}
  \item Once the Ubuntu desktop appears, you should see a window with the title ``Install''.
  ...
  \item Click ``Continue''.
  \item Ubuntu will begin installing onto the VM, be patient it will take 10-15 minutes to complete.
  \item Once the installation has completed, click the ``Restart Now'' button.
  \item Wait a few moments, an Ubuntu screen will appear telling you to remove the installation media.  DO NOT Press Enter Yet!

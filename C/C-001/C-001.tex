...
\date{May 2025} % Activate to display a given date or no date (if empty),
...
\input{04_hypervisor.tex}
\input{05_vm.tex}
\input{06_initlogin.tex}
\input{07_network.tex}
\input{08_updates.tex}

\input{09_hosts.tex}
\input{10_sshd.tex}
\input{11_sshclient.tex}
\input{12_vscode.tex}
\input{13_remoteplugins.tex}

\input{14_git.tex}
\input{15_docker.tex}
\input{16_devcontainer.tex}
\input{17_otherplugins.tex}

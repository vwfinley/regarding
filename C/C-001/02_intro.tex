...
The old way:
\begin{itemize}
  \item Monolith desktop development model.
  \item Everything on your local machine.
  \item Remote source control.
\end{itemize}

The new way:
\begin{itemize}
  \item Microservice/cloud/container model.
  \item Local machine is just a terminal.
  \item Development on remote (virtual) machine.
  \item Developer containers.
  \item Remote staging/deployment.
  \item Remote source control.
\end{itemize}
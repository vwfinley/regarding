...
\fancypagestyle{plain}{
  \fancyhf{} 
  \fancyhead[R]{}
  \fancyfoot[C]{\thepage\ of \pageref{LastPage}\\{\scriptsize https://github.com/vwfinley/regarding/blob/main/C/C-003/C-003.pdf}}
...
\title{C-003\\Regarding Container\\Images for LaTeX}
...
\date{December 2025\\Rev -} % Activate to display a given date or no date (if empty),
...
\input{01_intro.tex}
\input{02_solution.tex}
\input{03_texlive.tex}
\input{04_solutionA.tex}
\input{05_solutionB.tex}
\input{06_solutionC.tex}
\input{07_pipeline.tex}
\input{08_extensions.tex}

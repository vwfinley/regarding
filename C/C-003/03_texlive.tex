...
Of these three, the TeXLive\endnote{https://tug.org/texlive/} distribution is most appropriate for the Linux containers we will be targeting. 
...
\item TexLive library packages are kept in a mirrored\endnote{http://mirror.ctan.org/systems/texlive/tlnet} public registry, similar to how: GO Packages Repository\endnote{https://pkg.go.dev/}, PyPI\endnote{https://pypi.org/} and Maven Repository\endnote{https://mvnrepository.com/}; keep packages for their respective languages.  
\end{enumerate}

Aside from these maxims, the most important to remember is:
You'll always be missing some TexLive library packages you need, but you shouldn't worry, because you can easily add any missing packages.

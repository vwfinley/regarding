...
At first an author using LaTeX for typesetting may want to the use a LaTeX WYSIWYG editor like TeXworks\endnote{https://tug.org/texworks}.
...
However as an author gains more experience with LaTeX typesetting, and documents grow in complexity, the author will outgrow WYSIWYG tools.
This is to be anticipated since people usually abandon WYSIWYG wordprocessors as documents become complex.
...
The best way to achieve both aims is to containerize the LaTeX installation once and install the resulting container image as needed.
...
The pros and cons of each category will be discussed later in their respective sections.

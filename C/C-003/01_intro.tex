...
TeX is the typesetting system released by Donald Knuth\footnote{https://en.wikipedia.org/wiki/TeX} in 1978.
...
The reason everything looked so consistently academic is because your professors probably used LaTeX to typeset their course materials.

Aside from clean consistent layout the LaTeX system offers other benefits, to document authors, such as:
\begin{itemize}
...
Another main burden is a cumbersome environment setup.
